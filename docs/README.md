...
| [Documentation Viewer Design](./design-docs-viewer.md) | Build spec for the in-app docs/help viewer — the `DocumentSource` seam, the sanitizing render pipeline, the path-safe asset route (`visibility: internal`) |
