...
.SYNOPSIS
  ...
  subdomains - see docs/integration-satellite-apps.md section 6.6.
...
.DESCRIPTION
  ...
  NOTE: this file must stay pure ASCII. Windows PowerShell 5.1 parses a
  BOM-less script in the ANSI codepage, where a mangled em dash becomes a
  smart quote that PowerShell treats as a string terminator.
