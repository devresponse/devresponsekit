 ...
 * 
 * @export
 * @interface GroupRoleIdsRequest
 */
export interface GroupRoleIdsRequest {
    /**
     * 
     * @type {Array<string>}
     * @memberof GroupRoleIdsRequest
     */
    roleIds: Array<string>;
}

/**
 * Check if a given object implements the GroupRoleIdsRequest interface.
 */
export function instanceOfGroupRoleIdsRequest(value: object): value is GroupRoleIdsRequest {
    if (!('roleIds' in value) || value['roleIds'] === undefined) return false;
    return true;
}

export function GroupRoleIdsRequestFromJSON(json: any): GroupRoleIdsRequest {
    return GroupRoleIdsRequestFromJSONTyped(json, false);
}

export function GroupRoleIdsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupRoleIdsRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function GroupRoleIdsRequestToJSON(json: any): GroupRoleIdsRequest {
    return GroupRoleIdsRequestToJSONTyped(json, false);
}

export function GroupRoleIdsRequestToJSONTyped(value?: GroupRoleIdsRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
