...
import type { OrgMemberItem } from './OrgMemberItem';
import {
    OrgMemberItemFromJSON,
    OrgMemberItemFromJSONTyped,
    OrgMemberItemToJSON,
    OrgMemberItemToJSONTyped,
} from './OrgMemberItem';
...
export function OrgMemberListFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrgMemberList {
    ...
    return {
        ...
        'items': ((json['items'] as Array<any>).map(OrgMemberItemFromJSON)),
        'page': json['page'],
...
export function OrgMemberListToJSONTyped(value?: OrgMemberList | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(OrgMemberItemToJSON)),
        'page': value['page'],
