...
```ts
export const locales = ["en", "fr", "es", "uk", "pt", "zh"] as const;
...
NEXT_PUBLIC_SUPPORTED_LOCALES="en,fr,es,uk,pt,zh"
...
8. Seed translation files for English, French, Spanish, Ukrainian, Portuguese, and Simplified Chinese.
...
50. Locale routing works for `en`, `fr`, `es`, `uk`, `pt`, and `zh`.
