...
NEXT_PUBLIC_SUPPORTED_LOCALES="en,fr,es,uk,pt,zh,hi"
...
8. Seed translation files for English, French, Spanish, Ukrainian, Portuguese, Simplified Chinese, and Hindi.
...
50. Locale routing works for `en`, `fr`, `es`, `uk`, `pt`, `zh`, and `hi`.
