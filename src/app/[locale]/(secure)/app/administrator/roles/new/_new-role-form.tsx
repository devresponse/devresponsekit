...
/**
 * Client-side new-role form (docs/admin-manager.md §8.4;
 * docs/form-validation.md). React Hook Form + the shared `createRoleSchema` (same schema the API route enforces):
