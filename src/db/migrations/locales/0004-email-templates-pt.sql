-- locales/0004 — Seed pt (Portuguese) email templates.
--
-- Follows locales/0001–0003 (fr/es/uk): core 0001-initial-schema.sql seeded
-- only the `en` rows for `password_reset`
