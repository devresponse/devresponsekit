...
export const ADMIN_PERMISSION_CATALOG: ReadonlyArray<AdminPermissionDescriptor> = [
  ...
  { key: "admin.groups.read", description: "Read organization groups and their roles/members" },
  { key: "admin.groups.create", description: "Create organization groups" },
  { key: "admin.groups.update", description: "Edit organization groups" },
  { key: "admin.groups.delete", description: "Delete organization groups" },
  { key: "admin.groups.assign", description: "Manage a group's roles and members" },
